...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.86\textwidth]{assets/yum-wall-desktop-20260514-car-variety.png}
    \caption{Desktop view of the deployed Yum wall after the vehicle lane restored modern-sedan variety while retaining Audi A3 build A0J42547 as a local anchor. The visible mix shows the core design tension: category balance, source quality, and visual-group spacing must hold while the car lane avoids repeated adjacent vehicles.}
    \label{fig:desktop}
\end{figure}
