...
const carItems = [
  {
    file: "2025 BMW 2-Series 220 Gran Coup\u00e9 M Sport Pro.jpg",
    caption: "2025 BMW 2 Series Gran Coupe, compact sedan future-garage energy.",
    shape: "wide",
    focus: "center 50%",
    width: 1800,
  },
  {
    file: "BMW U11 X1 M35i IMG 0023.jpg",
    caption: "BMW X1 M35i, compact SUV with city-size luxury and weekend speed.",
    shape: "portrait",
    focus: "center 48%",
    width: 1800,
  },
  {
    file: "BMW U10 X2 M35i IMG 9777.jpg",
    caption: "2024 BMW X2 M35i, small crossover coupe with a clean aggressive stance.",
    shape: "portrait",
    focus: "center 50%",
    width: 1800,
  },
  {
    file: "Mercedes-Benz CLA 180 Night Edition (C118) front.jpg",
    caption: "Mercedes CLA, compact sedan silhouette with quiet rich-person polish.",
    shape: "wide",
    focus: "center 50%",
    width: 1800,
  },
  {
    file: "Mercedes-AMG CLA 45 S 4MATIC+ (C118) 1X7A1741.jpg",
    caption: "Mercedes-AMG CLA 45 S, compact daily dream with just enough drama.",
    shape: "wide",
    focus: "center 50%",
    width: 1800,
  },
  {
    file: "Mercedes-AMG GLA 35 4MATIC (H247) front.jpg",
    caption: "Mercedes GLA 35, compact SUV dopamine without giant-car energy.",
    shape: "portrait",
    focus: "center 48%",
    width: 1800,
  },
  {
    file: "Mercedes-Benz X247 FL GLB 200d Progressive Night Black (3).jpg",
    caption: "Mercedes GLB in black, compact SUV but still grown-up and useful.",
    shape: "wide",
    focus: "center 54%",
    width: 1800,
  },
  {
    file: "Audi A3 40 TFSI S Line Premium 8Y FL Mythos Black Metallic (3).jpg",
    caption: "2025-ish Audi A3 S line, compact sedan, black paint, clean ambition.",
    shape: "wide",
    focus: "center 52%",
    width: 1800,
  },
  {
    file: "2025 Audi RS3 8Y Sedan IMG 2633.jpg",
    caption: "2025 Audi RS3 sedan, small, sharp, and fast without muscle-car bulk.",
    shape: "portrait",
    focus: "center 50%",
    width: 1800,
  },
  {
    file: "Audi Q4 Sportback e-tron DSC 7471.jpg",
    caption: "Audi Q4 Sportback e-tron, compact electric SUV with smooth future lines.",
    shape: "wide",
    focus: "center 52%",
    width: 1800,
  },
  {
    file: "Volvo EX30 GIMS 2024 1X7A2378.jpg",
    caption: "Volvo EX30, tiny electric SUV, minimalist and weirdly expensive-feeling.",
    shape: "portrait",
    focus: "center 48%",
    width: 1800,
  },
  {
    file: "Mini Countryman (U25) IMG 9537.jpg",
    caption: "2024 Mini Countryman, compact crossover, playful but still premium.",
    shape: "wide",
    focus: "center 52%",
    width: 1800,
  },
